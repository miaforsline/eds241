...
mdl4 <- lm(birthwgt ~ tobacco + as.factor(g), data = data_matching)

se_models <- starprep(mdl4, stat = c("std.error"), se_type = "HC2", alpha = 0.05)

stargazer(mdl4, se = se_models, type="text")
```
