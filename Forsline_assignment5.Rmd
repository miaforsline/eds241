...
\noindent Furthermore, on average, houses located near the incinerator are approximately `r age_coef` years older than houses located far from the incinerator (p-value < 0.05). This also illustrates how the incinerator was likely not placed randomly. 
