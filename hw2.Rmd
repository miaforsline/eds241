...
\newpage
<center>**Figure 1: Histogram of change in total NO~x~ emissions from all power plants in a county between 2000 and 2008 (in tons)**</center>
...
stargazer(mod, mod2, type = "latex", ci=FALSE, no.space = TRUE, 
          ...
          covariate.labels = c("NBP", "D", "Interaction"), dep.var.labels = c("NOx Change (tons)"),
          dep.var.caption = c(""),
...
b) counties that have a fraction of the county population that is African American *above* the median reported value of `r npb_coefficient`, regardless of whether they participated in the NO~x~ Budget Program 
